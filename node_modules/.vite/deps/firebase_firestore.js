...
var __PRIVATE_SimpleDb = class ___PRIVATE_SimpleDb {
  ...
  static F() {
    var _a;
    return "undefined" != typeof process && "YES" === ((_a = process.__PRIVATE_env) == null ? void 0 : _a.__PRIVATE_USE_MOCK_PERSISTENCE);
  }
   ...
   */
  async L(e) {
    return this.db || (__PRIVATE_logDebug(L, "Opening database:", this.name), this.db = await new Promise(((t, n) => {
...
var __PRIVATE_IndexBackfillerScheduler = class {
  ...
  re(e) {
    __PRIVATE_logDebug(K, `Scheduled in ${e}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill", e, (async () => {
      this.task = null;
      try {
        const e2 = await this.ne.ie();
        __PRIVATE_logDebug(K, `Documents written: ${e2}`);
      } catch (e2) {
        __PRIVATE_isIndexedDbTransactionError(e2) ? __PRIVATE_logDebug(K, "Ignoring IndexedDB error during index backfill: ", e2) : await __PRIVATE_ignoreIfPrimaryLeaseLoss(e2);
      }
      await this.re(6e4);
    }));
  }
      ...
      if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
        ...
        if (r2 !== n) {
          ...
          Vt == null ? void 0 : Vt.o((function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e2, t2, n3, r3, i3) {
            ...
            o && (s.bloomFilter = {
              applied: 0 === i3,
              hashCount: (o == null ? void 0 : o.hashCount) ?? 0,
              bitmapLength: ((_b = (_a = o == null ? void 0 : o.bits) == null ? void 0 : _a.bitmap) == null ? void 0 : _b.length) ?? 0,
              padding: ((_c = o == null ? void 0 : o.bits) == null ? void 0 : _c.padding) ?? 0,
              mightContain: (e3) => (r3 == null ? void 0 : r3.mightContain(e3)) ?? false
            });
            return s;
...
var __PRIVATE_IndexedDbGlobalsCache = class {
  ...
  getSessionToken(e) {
    return this.bt(e).get("sessionToken").next(((e2) => {
      const t = e2 == null ? void 0 : e2.value;
...
function __PRIVATE_computeInExpansion(e) {
  ...
  if (__PRIVATE_hardAssert(e instanceof FieldFilter || e instanceof CompositeFilter, 20012), e instanceof FieldFilter) {
    if (e instanceof __PRIVATE_InFilter) {
      const t2 = ((_b = (_a = e.value.arrayValue) == null ? void 0 : _a.values) == null ? void 0 : _b.map(((t3) => FieldFilter.create(e.field, "==", t3)))) || [];
...
var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
  ...
  getDocumentsMatchingQuery(e, t, n, r, i) {
    ...
    return __PRIVATE_remoteDocumentsStore(e).J(IDBKeyRange.bound(o, _, true)).next(((e2) => {
      i == null ? void 0 : i.incrementDocumentReadCount(e2.length);
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  async shutdown() {
    ...
    await this.Ki.runTransaction("shutdown", "readwrite", [W, Ve], ((e) => {
  ...
  Qi() {
    var _a;
    "function" == typeof ((_a = this.window) == null ? void 0 : _a.addEventListener) && (this.Oi = () => {
      this._s();
  ...
  ss(e) {
    var _a;
    try {
      const t = null !== ((_a = this.Ui) == null ? void 0 : _a.getItem(this.rs(e)));
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  async start() {
    const e = await this.syncEngine.hs();
    for (const t2 of e) {
        ...
        if (this.started) {
          if (null !== t.key) {
            if (this.eo.test(t.key)) {
              ...
              await Promise.all(e2.map(((e3) => this.syncEngine.So(e3))));
            }
          }
        } else this.Zs.push(t);
      }));
...
var __PRIVATE_BundleLoader = class {
   ...
   */
  async ja(e) {
    const t = await __PRIVATE_localStoreApplyBundledDocuments(e, new __PRIVATE_BundleConverterImpl(this.serializer), this.Qa, this.$a.id), n = this.za(this.documents);
    for (const t2 of this.Wa) await __PRIVATE_localStoreSaveNamedQuery(e, t2, n.get(t2.name));
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  async initialize(e) {
    ...
    // set it after localStore / remoteStore are started.
    await this.persistence.zi((async (e2) => {
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    ...
    this.ku().then(((e2) => {
      e2 && e2.Ua() ? this.metadata.resolve(e2.Ka.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(e2 == null ? void 0 : e2.Ka)}`));
  ...
  async Uu(e) {
    for (; this.buffer.length < e; ) {
      await this.Wu() && this.Ku("Reached the end of bundle when more is expected.");
    }
...
var __PRIVATE_BundleReaderSyncImpl = class {
  constructor(e, t) {
    ...
    if (!n || !n.Ua()) throw new Error(`The first element of the bundle is not a metadata object, it is
         ${JSON.stringify(n == null ? void 0 : n.Ka)}`);
    this.metadata = n;
    do {
  ...
  return e.asyncQueue.enqueueAndForget((async () => {
    try {
      ...
      r.resolve((async function __PRIVATE_invokeRunAggregationQueryRpc(e2, t2, n2) {
        ...
        const a = (_a = _[0].result) == null ? void 0 : _a.aggregateFields;
...
function enableIndexedDbPersistence(e, t) {
  ...
  return __PRIVATE_setPersistenceProviders(e, OnlineComponentProvider.provider, {
    build: (e2) => new __PRIVATE_IndexedDbOfflineComponentProvider(e2, n.cacheSizeBytes, t == null ? void 0 : t.forceOwnership)
  }), Promise.resolve();
}
...
function _internalQueryToProtoQueryTarget(e) {
  var _a;
  const t = ensureFirestoreConfigured(__PRIVATE_cast(e.firestore, Firestore)), n = (_a = t._onlineComponents) == null ? void 0 : _a.datastore.serializer;
...
function _internalAggregationQueryToProtoRunAggregationQueryRequest(e, t) {
  var _a;
  const n = __PRIVATE_mapToArray(t, ((e2, t2) => new __PRIVATE_AggregateImpl(t2, e2.aggregateType, e2._internalFieldPath))), r = ensureFirestoreConfigured(__PRIVATE_cast(e.firestore, Firestore)), i = (_a = r._onlineComponents) == null ? void 0 : _a.datastore.serializer;
...
var __PRIVATE_MemoryLocalCacheImpl = class {
  constructor(t) {
    this.kind = "memory", this._onlineComponentProvider = OnlineComponentProvider.provider, this._offlineComponentProvider = (t == null ? void 0 : t.garbageCollector) ? t.garbageCollector._offlineComponentProvider : {
...
var __PRIVATE_PersistentLocalCacheImpl = class {
  constructor(t) {
    let e;
    this.kind = "persistent", (t == null ? void 0 : t.tabManager) ? (t.tabManager._initialize(t), e = t.tabManager) : (e = persistentSingleTabManager(void 0), e._initialize(t)), this._onlineComponentProvider = e._onlineComponentProvider, this._offlineComponentProvider = e._offlineComponentProvider;
  }
  toJSON() {
    return {
      kind: this.kind
...
function memoryLruGarbageCollector(t) {
  return new __PRIVATE_MemoryLruGarbageCollectorImpl(t == null ? void 0 : t.cacheSizeBytes);
}
...
var __PRIVATE_SingleTabManagerImpl = class {
  ...
  _initialize(t) {
    this._onlineComponentProvider = OnlineComponentProvider.provider, this._offlineComponentProvider = {
      build: (e) => new __PRIVATE_IndexedDbOfflineComponentProvider(e, t == null ? void 0 : t.cacheSizeBytes, this.forceOwnership)
    };
  }
};
var __PRIVATE_MultiTabManagerImpl = class {
  ...
  _initialize(t) {
    this._onlineComponentProvider = OnlineComponentProvider.provider, this._offlineComponentProvider = {
      build: (e) => new __PRIVATE_MultiTabOfflineComponentProvider(e, t == null ? void 0 : t.cacheSizeBytes)
    };
  }
};
function persistentSingleTabManager(t) {
  return new __PRIVATE_SingleTabManagerImpl(t == null ? void 0 : t.forceOwnership);
}
  ...
  const r = (function __PRIVATE_parseIndexes(t2) {
    const e2 = "string" == typeof t2 ? (function __PRIVATE_tryParseJson(t3) {
      try {
        ...
        throw new FirestoreError(D.INVALID_ARGUMENT, "Failed to parse JSON: " + (t4 == null ? void 0 : t4.message));
      }
    })(t2) : t2, n2 = [];
...
function getPersistentCacheIndexManager(t) {
  ...
  if (e) return e;
  const n = ensureFirestoreConfigured(t);
  if ("persistent" !== ((_a = n._uninitializedComponentsProvider) == null ? void 0 : _a._offline.kind)) return null;
